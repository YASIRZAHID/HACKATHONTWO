...
export default function Screen3() {
  ...
  let slide1 = products.filter((product) => product?.priority == "slide1");
  let slide2 = products.filter((product) => product?.priority == "slide2");
  let slide3 = products.filter((product) => product?.priority == "slide3");
  return (
